...
<body>
    ...
    <div class="main">
        <div class="container text-center userform-box">
            ...
            <form name="updateForm" action="/users/${user.id}" method="post">
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                 ...
                 <div class="mb-3 row">
                     ...
                     <div class="col-sm-3">
                         <input type="website" class="form-control" id="website" name="website" value="${user.website}">
                     </div>
                 </div>

                <div class="userform-btn-box">
                    <input type="hidden" name="_method" value="put">
                    <button id="updateBtn" type="button" class="btn btn-primary userform-btn">수정</button>
                </div>
            </form>
        </div>
    </div>
